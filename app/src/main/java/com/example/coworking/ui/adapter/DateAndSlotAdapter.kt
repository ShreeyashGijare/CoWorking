...
class DateAndSlotAdapter(
    private val context: Context,
    private val slotClickListener: SlotClickListener
) : RecyclerView.Adapter<DateAndSlotAdapter.MainViewHolder>() {

    private var availableSlotsList: MutableList<Slot> = ArrayList()
    ...
    override fun onBindViewHolder(holder: MainViewHolder, position: Int) {
        holder.binding.tvTimeSlot.text = availableSlotsList[position].slot_name
        ...
        if (selectedSlot == position) {
            ...
            when (availableSlotsList[position].slot_active) {
                true -> {
        ...
        holder.itemView.setOnClickListener {
            ...
            slotClickListener.dateAndSlotClickListener(availableSlotsList[position])
            notifyDataSetChanged()
        }
    }

    fun updateList(availableSlotsList: ArrayList<Slot>) {
